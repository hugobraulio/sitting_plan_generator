...
/** Returns the row number (starting from 0) of a given 'hall_position' (hp)
* @param hp The value of the generated_hall_position property of an students (i.e: "D1", "B6", "C13", "A1", etc)
