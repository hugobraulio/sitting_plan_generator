...
function Hall(course_json){
    ...
    this.male           = { "num_std": male_num_std, //TODO: Si mueves este codigo fuera del constructor, entonces agrega los no_seat a la suma
							...
							"nrows": Math.ceil(male_num_std / course_json.hall_config.male.number_of_columns)
						  };
...
Hall.prototype.getNumberOfRows = function(gender){
    return this[gender].nrows;
}
